...
from mmdet_v2200.core import build_sampler, fast_nms, images_to_levels, multi_apply
from mmdet_v2200.core.utils import select_single_mlvl
...
class YOLACTHead(AnchorHead):
    ...
    def _get_bboxes_single(self,
        ...
        if self.use_sigmoid_cls:
            ...
            # remind that we set FG labels to [0, num_class-1] since mmdet_v2200 v2.0
            # BG cat_id: num_class
...
class YOLACTProtonet(BaseModule):
    ...
    def forward(self, x, coeff_pred, bboxes, img_meta, sampling_results=None):
        ...
        # Fix https://github.com/open-mmlab/mmdet_v2200ection/issues/5978
