...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from mmdet_v2200.core.mask.structures import *  # NOQA
    ...
    def translate(self,
        ...
        Example:
            >>> from mmdet_v2200.core.mask.structures import BitmapMasks
    ...
    def random(cls,
        ...
        """
        from mmdet_v2200.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from mmdet_v2200.core.mask.structures import PolygonMasks
