...
class SignAttack(BlackBoxAttack):
    ...
    def __init__(self, max_loss_queries, epsilon, p, fd_eta, lb, ub, name, attack_model, attack_mode, attack_logistics, loss, targeted, ori_img, model_name):
        """
        ...
        other params reference to attack method
        """
