...
from classify_utils import imshow, image_folder_custom_label
...
if __name__ == '__main__':
    ...
    class_idx = json.load(open("transfer_attack/imagenet_class_index.json"))
    ...
    dataset = image_folder_custom_label(root='/public/data/data/imagenet/Sample_1000', transform=trans, idx2label=idx2label)
