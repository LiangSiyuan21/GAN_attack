...
from transfer_attack.attacks.taig import TAIG 
...
def main():
    ...
    for index, data in enumerate(data_loader):
        ...
        attack = TAIG(model, eps=12.5/255, alpha=1/255, steps=int(args.n_iter), decay=1.0, resize_rate=0.9, diversity_prob=0.7, random_start=False, ub=ub, lb=lb)
