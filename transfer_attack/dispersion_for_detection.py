...
from transfer_attack.attacks.dispersion import DispersionAttack_gpu
...
def main():
    ...
    #     continue
        ...
        attack = DispersionAttack_gpu(
            model, epsilon=12.5/255, step_size=1./255, steps=20, lb=lb, ub=ub)
        internal = [i for i in range(50)]
        adv = attack(data, 
            attack_layer_idx=3, 
            internal=internal, 
            )
