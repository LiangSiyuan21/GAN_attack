...
from mmdet_v2200.core.evaluation import DistEvalHook, EvalHook
from mmdet_v2200.datasets import (DATASETS, ClassBalancedDataset, CocoDataset,
...
@patch('mmdet_v2200.datasets.CocoDataset.load_annotations', MagicMock)
@patch('mmdet_v2200.datasets.CustomDataset.load_annotations', MagicMock)
@patch('mmdet_v2200.datasets.XMLDataset.load_annotations', MagicMock)
@patch('mmdet_v2200.datasets.CityscapesDataset.load_annotations', MagicMock)
@patch('mmdet_v2200.datasets.CocoDataset._filter_imgs', MagicMock)
@patch('mmdet_v2200.datasets.CustomDataset._filter_imgs', MagicMock)
@patch('mmdet_v2200.datasets.XMLDataset._filter_imgs', MagicMock)
@patch('mmdet_v2200.datasets.CityscapesDataset._filter_imgs', MagicMock)
...
@patch('mmdet_v2200.apis.single_gpu_test', MagicMock)
@patch('mmdet_v2200.apis.multi_gpu_test', MagicMock)
