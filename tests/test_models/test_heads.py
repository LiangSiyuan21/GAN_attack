...
from mmdet_v2200.core import bbox2roi, build_assigner, build_sampler
from mmdet_v2200.core.evaluation.bbox_overlaps import bbox_overlaps
from mmdet_v2200.models.dense_heads import (AnchorHead, CornerHead, FCOSHead,
                                      FSAFHead, GuidedAnchorHead, PAAHead,
                                      SABLRetinaHead, YOLACTHead,
                                      YOLACTProtonet, YOLACTSegmHead, paa_head)
from mmdet_v2200.models.dense_heads.paa_head import levels_to_images
from mmdet_v2200.models.roi_heads.bbox_heads import BBoxHead, SABLHead
from mmdet_v2200.models.roi_heads.mask_heads import FCNMaskHead, MaskIoUHead
...
def test_refine_boxes():
    ...
    ``mmdet_v2200.models.bbox_heads.bbox_head.BBoxHead.refine_boxes`` but checks for
...
def _demodata_refine_boxes(n_roi, n_img, rng=0):
    ...
    ``mmdet_v2200.models.bbox_heads.bbox_head.BBoxHead.refine_boxes`` method."""
    import numpy as np
    from mmdet_v2200.core.bbox.demodata import random_boxes
    from mmdet_v2200.core.bbox.demodata import ensure_rng
    try:
        import kwarray
    except ImportError:
        import pytest
...
def test_mask_head_loss():
    ...
    # create dummy mask
    import numpy as np
    from mmdet_v2200.core import BitmapMasks
