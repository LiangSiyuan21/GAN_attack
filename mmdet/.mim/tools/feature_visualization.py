...
def draw_feature_map(features,save_dir = 'feature_map',name = 'original', img=None, visualize_fea_pth=None):
    i=0
    if (visualize_fea_pth is not None):
