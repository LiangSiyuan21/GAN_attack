...
class DeprecatedFp16OptimizerHook(Fp16OptimizerHook):
    ...
    :class:`Fp16OptimizerHook` from `mmdet_v2200.core` will be deprecated.
    ...
    def __init__(*args, **kwargs):
        ...
        warnings.warn(
            'Importing Fp16OptimizerHook from "mmdet_v2200.core" will be '
...
def deprecated_auto_fp16(*args, **kwargs):
    warnings.warn(
        'Importing auto_fp16 from "mmdet_v2200.core" will be '
        'deprecated in the future. Please import them from "mmcv.runner" '
        'instead')
...
def deprecated_force_fp32(*args, **kwargs):
    warnings.warn(
        'Importing force_fp32 from "mmdet_v2200.core" will be '
        'deprecated in the future. Please import them from "mmcv.runner" '
        'instead')
...
def deprecated_wrap_fp16_model(*args, **kwargs):
    warnings.warn(
        'Importing wrap_fp16_model from "mmdet_v2200.core" will be '
        'deprecated in the future. Please import them from "mmcv.runner" '
        'instead')
