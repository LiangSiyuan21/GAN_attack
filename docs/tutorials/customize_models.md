...
```python
custom_imports = dict(
    imports=['mmdet_v2200.models.backbones.mobilenet'],
...
```python
custom_imports = dict(
    imports=['mmdet_v2200.models.necks.mobilenet'],
    allow_failed_imports=False)
```
...
```python
from mmdet_v2200.models.builder import HEADS
...
from mmdet_v2200.core import bbox2result, bbox2roi, build_assigner, build_sampler
...
```python
custom_imports=dict(
    imports=['mmdet_v2200.models.roi_heads.double_roi_head', 'mmdet_v2200.models.bbox_heads.double_bbox_head'])
```
...
```python
custom_imports=dict(
    imports=['mmdet_v2200.models.losses.my_loss'])
```
