...
def main():
    ...
    for m in args.ensemble_models.split(' '):
        ...
        #    ensemble_checkpoint = '/srv/hdd/weight/od-black/checkpoints/faster_rcnn_r50_fpn_2x_coco_bbox_mAP-0.384_20200504_210434-a5d8aa15.pth'
    ...
    if args.attack.split('_')[0] == 'IoUzosignsgd':
        ...
        results_records_iter_list = demo_utils.results_records_iter_list_for_zosignsgd
    elif args.attack.split('_')[0] == 'IoUmgaGT':
        results_records_iter_list = demo_utils.results_records_iter_list_for_square
    ...
    #     continue
        ...
        if vis_attack_step is not None and vis_attack_step:
            queries, vis_result, results_records, queries_records = attacker.run(data, loss_fct_with_iou, early_stop_crit_fct_with_iou, vis_attack_step=vis_attack_step, results_records=results_records, quires_records=quires_records, gt_info=[gt_bboxes, gt_scores, gt_labels, labels_dic])
        else:
