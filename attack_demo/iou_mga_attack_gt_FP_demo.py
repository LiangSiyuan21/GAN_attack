...
from blackbox_attack.utils.criterion import loss_fct, early_stop_crit_fct, early_stop_crit_fct_with_iou, loss_fct_with_iou, loss_fct_with_FP
...
def main():
    ...
    if args.attack.split('_')[0] == 'IoUzosignsgd':
        ...
        results_records_iter_list = demo_utils.results_records_iter_list_for_zosignsgd
    elif args.attack.split('_')[0] == 'IoUmgaGT' or args.attack.split('_')[0] == 'IoUmgaGTFP' or args.attack.split('_')[0] == 'IoUmgaGTFPiter' or args.attack.split('_')[0] == 'IoUmgaGTTPFPiter':
        results_records_iter_list = demo_utils.results_records_iter_list_for_square
