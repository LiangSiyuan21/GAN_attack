# -*- encoding: utf-8 -*-
'''
@File    :   iou_sign_attack_demo.py
@Time    :   2021/01/04 16:31:29
@Author  :   liangsiyuan 
'''
...
from blackbox_attack.iou_sign_attack import IoUSignAttack
...
def parse_args():
    ...
    # attack argument
    parser.add_argument('--attack', type=str, default='IoUsign_linf', choices=['IoUsign_linf', 'IoUsign_l2'], help='Attack.')
