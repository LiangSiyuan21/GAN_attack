...
from blackbox_attack.iou_square_attack import IoUSquareAttack 
...
def parse_args():
    ...
    parser.add_argument('--p', type=str, default='inf', choices=['inf', '2'])
...
def main():
    ...
    log.logger.info('All {} images: mean quries {}, median_quries {}, mode_quries {}, mean times {}'.format(len(data_loader), mean_quries, median_quries, mode_quries, mean_times)) 
