...
# from torch.nn.modules.module import Tensor
import util as demo_utils
from datetime import datetime
import blackbox_attack.square_attack.utils as sq_utils
from blackbox_attack.utils.criterion import loss_fct, early_stop_crit_fct, early_stop_crit_fct_with_iou, loss_fct_with_iou, loss_fct_with_TP_add_FP
...
from blackbox_attack.mga_attack import IoUMGAAttack
...
def main():
    ...
    for m in args.ensemble_models.split(' '):
        ...
        #    ensemble_checkpoint = '/apdcephfs/share_1367250/selenaliang/weight/od-black/checkpoints/faster_rcnn_r50_fpn_2x_coco_bbox_mAP-0.384_20200504_210434-a5d8aa15_v2200.pth'
           ...
           ens_model = MMDataParallel(ens_model, device_ids=DEVICE_IDS)
        #    ens_model.eval()
           ens_models.append(ens_model)
    
    log.logger.info('checkpoints have been finishe into object detection ensemble model...')
    ...
    elif args.attack.split('_')[0] == 'IoUmga':
        results_records_iter_list = demo_utils.results_records_iter_list_for_zosignsgd
    ...
    #     continue
        ...
        attacker = eval('IoUMGAAttack')(
            ...
            ensemble_iters = int(args.ensemble_iters),
            visual_iters_path = visual_iters_path
        )
        # adversary = LinfMGA(model, pop_size=args.pop_size, generations=50000, lb=lb, ub=ub, cross_rate=args.cr, targeted=args.targeted,
                        # mutation_rate=args.mr, max_queries=args.n_iter,
                        # epsilon=args.eps, iters=args.iters, ensemble_models=ens_models)
