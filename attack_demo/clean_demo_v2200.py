...
def main():
    ...
    cfg.data.test.ann_file = '/public/data/coco/coco2017_top100_5/coco2017_5_0/annotations/instances_val2017.json' 
    cfg.data.test.img_prefix = '/public/data/coco/coco2017_top100_5/coco2017_5_0/val2017'
