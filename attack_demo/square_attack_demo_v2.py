...
from blackbox_attack.square_attack_v2 import SquareAttack
...
def parse_args():
    ...
    # attack argument
    parser.add_argument('--attack', type=str, default='square_linf', help='Attack.')
