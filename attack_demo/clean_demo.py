...
def main():
    ...
    if samples_per_gpu > 1:
        # Replace 'ImageToTensor' to 'DefaultFormatBundle'ol,, 
        cfg.data.test.pipeline = replace_ImageToTensor(cfg.data.test.pipeline)
    cfg.data.test.ann_file = '/srv/hdd/data/coco2017_top100/annotations/instances_val2017.json' 
    cfg.data.test.img_prefix = '/srv/hdd/results/efficient-od-black/fig1/transfer_m_di_tifgsm_attack/ssd/adv_20_z_10/1/FR'
