...
# -*- encoding: utf-8 -*-
'''
@File    :   iou_zo_sign_sgd_attack_demo.py
...
import time
import sys
# sys.path.insert(0, '/apdcephfs/private_xiaojunjia/liangsiyuan/code/od-black/baseline/mmdetection')
import numpy as np
import pandas as pd
import torch
import argparse
...
from blackbox_attack.zo_sign_sgd_attack import ZOSignSGDAttack
...
def parse_args():
    ...
    # attack argument
    parser.add_argument('--attack', type=str, default='IoUzosignsgd_linf', choices=['IoUzosignsgd_linf', 'IoUzosignsgd_l2'], help='Attack.')
    ...
    parser.add_argument('--fd_eta', type=float, default=0.001)
...
def main():
    ...
    # log_path = '{}/{}.log'.format(args.1exp_folder, hps_str)
